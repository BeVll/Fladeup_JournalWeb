...
export const EditPersonalTeacherInformation = ({id}:{id:number}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            TeacherApi.updateTeacher(values, id.toString()).then(res => {
                getStudent();
                notify();
                formik.resetForm();
            }).catch(() => {
    ...
    const getStudent = () => {
        setLoading(true);
        TeacherApi.getDetailedTeacherUpdate(id.toString()).then(res => {
